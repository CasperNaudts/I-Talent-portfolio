        ...
        <div className="portfolio-internationaal">
            ...
            <div className="portfolio-internationaal-opdracht">
                <div className="portfolio-internationaal-opdracht-left">
                    <Text variant="large">Het thema van de Bus-IT week was drones. We leerden drones aansturen via ROS (Robot Operationg System). De uiteindelijke opdracht was om de drone een lijn door een virtueel aardbeienveld te laten volgen en dan het aantal aardbeien dat aan de struiken hing te tellen. Ons team is er in geslaagd om via de camera van de drone de lijn te laten identificeren. Ook konden we aardbeien van de rest van de omgeving onderscheiden. Het is ons niet gelukt de drone de lijn te laten volgen en na te gaan of we een bepaalde aardbei al geteld hadden.</Text>
                    <br/>
                    <Text variant="large">Uiteindelijke mochten we onze software een echte drone laten aansturen. Hiervoor gingen we naar DronePort. Eerst kregen we een rondleiding doorheen de campus en nadien lunchten we daar ook. Nadien begonnen we de drone te connecteren met de laptop. Dit was moeilijker dan verwacht omdat het wifi signiaal van de drone erg zwak en onstabiel was, waardoor de verbinding vaak onderbrak. Eens we verbonden waren, konden we de software zijn werk laten doen. Jammer genoeg duurde ons geluk niet lang omdat we na het comando vooruitvliegen de connectie met de drone verloren. Hierdoor bleef de drone verder vliegen omdat hij geen commando binnen kreeg om te stoppen met vooruitvliegen. Helaas is de drone toen tegen een muur van de hangar gevlogen en was er een beschermend stuk van de drone afgebroken.</Text>
                    <br/>
                    <Text variant="large">Ik vond de Bus-IT week zeer interesant omdat dit niet direct een onderwerk is waarmee ik in contact zou komen. Samenwerken met externe studenten was zeer leuk en we hebben ook veel van elkaar geleerd. Het feit dat ik de "local" student was vond ik heel fijn omdat ik anderen kon helpen bij eventuele vragen buiten de ingeplande momenten.</Text>
                </div>
